...
//  nodex: "/nodex.png",
//  istio: "/istio.png",
//  rabbitmqx: "/rabbitmq.png",
//  rabbitmq: "/rabbitmq.png",
//  grafana: "/grafana.png",
//  prometheus: "/nodex.png",
//};
...
function Buttons() {
  const storedServices = JSON.parse(localStorage.getItem("services")) || [
    ...
    { name: "nodex", isOn: false },
    { name: "istio", isOn: false },
    { name: "rabbitmqx", isOn: false },
    { name: "rabbitmq", isOn: false },
    { name: "grafana", isOn: false },
  ];
    ...
    <div className="container-b">
      ...
      <div className="services-list">
        {services.map((service, index) => (
          ...
          >
            {/* Render service logo next to the service name
            {serviceLogos[service.name] && (
              <img
                ...
                style={{
                  width: "20px",
                  height: "20px",
                  marginRight: "2px", // Space between logo and name
      ...
      <div className="add-service">
        <div className="input-container" style={{ position: "relative" }}>
          ...
          <div className="backup-b">
            <span onClick={() => backupLocalStorage(setStatusMessage)}>
              <img
            ...
            <input
              ...
              accept=".json"
              onChange={(event) =>
                restoreFromBackupFile(event, setStatusMessage)
              }
              style={{
                display: "none",
              }}
            ...
            {/* <span onClick={clearLocalStorage}>
              <img
            ...
            {/* <span onClick={restoreLocalStorage} className="restore-btn">
              <img
